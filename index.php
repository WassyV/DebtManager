				  ...
				  <div class="col-md-4">
                        <div class="main-box mb-purple">
                            <a href="student.php">
                                ...
                                <h4>Total Customers: <?php include 'counter/stucount.php'?></h4>
					 ...
					 <div class="col-md-4">
                        <div class="main-box mb-secondary">
                            <a href="report.php">
                                ...
                                <h4>Available Actions: <?php include 'counter/totalgrade.php'?></h4>
                                <h5>Debtors Actions</h5>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="main-box mb-dull">
                            <a>
                                ...
                                <h5>Active Customers: <?php include 'counter/activecount.php'?></h5>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="main-box mb-yell">
                            <a href="inactivestd.php">
                                ...
                                <h5>In-Active Customer: <?php include 'counter/inactivecount.php'?></h5>
                            </a>
                        </div>
                    </div>
                </div>
