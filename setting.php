...
?>
               ...
               <div class="panel panel-success" >
						...
						<div class="form-group">
								<label class="col-sm-4 control-label" for="Old" style="color:black;">Old Password</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label" for="Password" style="color:black;"> New Password</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label" for="Confirm" style="color:black;">Confirm Password</label>
								<div class="col-sm-5">
