...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Payment  
...
<fieldset class="scheduler-border" >
    <legend  class="scheduler-border" style="color:#aaa;">Search:</legend>
<form class="form-inline" role="form" id="searchform" >
  <div class="form-group">
    <label for="email" style="color:#aaa;">Name</label>
    <input type="text" class="form-control" id="student" name="student">
  </div>
  
   <div class="form-group">
    <label for="email" style="color:#aaa;"> Date Of Payment </label>
    <input type="text" class="form-control" id="doj" name="doj" >
  </div>
  
  <div class="form-group">
    <label for="email" style="color:#aaa;"> Action </label>
    <select  class="form-control" id="grade" name="grade" >
		<option value="" style="color:#aaa;">Select Action</option>
                                    <?php
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body" id="formcontent" style="color:black;">
